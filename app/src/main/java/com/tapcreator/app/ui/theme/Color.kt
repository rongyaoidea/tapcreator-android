...
// ══════════════════════════════════════════════════════════════════
// tapcreator Brand 完善主题色
// 暖中性色背景 + 少而精的三色强调系统
// ══════════════════════════════════════════════════════════════════

// ── 强调色（三色系统：少而精）──
val Brand = Color(0xFFD97757)        // Primary 橙色：品牌主色，用于主要操作和 Logo
val BrandDim = Color(0xFFC96442)     // 加深变体（hover/pressed，满足 WCAG 对比度）
val BrandSoft = Color(0xFFF5E6DE)    // 浅色 container

val BrandBlue = Color(0xFF6A9BCC)    // Secondary 蓝色：次要强调
val BrandBlueDark = Color(0xFF8BB8E0)
val BrandBlueSoft = Color(0xFFE8F0F7)

val BrandGreen = Color(0xFF788C5D)   // Tertiary 绿色：第三强调
val BrandGreenDark = Color(0xFF9AAE7A)
val BrandGreenSoft = Color(0xFFEFF2E8)
...
// ── 主题槽位补全 ──
val TertiaryBrand = Color(0xFFC96442)       // 浅色
val TertiaryBrandDark = Color(0xFFE89968)  // 深色
val TertiaryBrandSoft = Color(0xFFF5E6DE)  // 浅色 container
val TertiaryBrandSoftDark = Color(0xFF3A2A20) // 深色 container
